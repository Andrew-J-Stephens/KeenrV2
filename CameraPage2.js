...
function HomeNav() {
    ...
    return(
        <View style = {{width: '100%', flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: windowWidth*0.025, paddingTop: 60}}>
            ...
            <View style = {{backgroundColor: weeklyColor, paddingHorizontal: 30, flexDirection: 'column', justifyContent: 'center', borderRadius: 10}}>
                <Text style = {{color: 'white', fontWeight: 'bold', fontSize: '20%'}}t>Weekly Challenge</Text>
            </View>
        </View>
    );
    }

export default function CameraPage2({navigation, route}) {
...
const takePicture = async () => {
  ...
  return (
   <View style={{ flex: 1}}>
      ...
      <TouchableOpacity onPress={() => takePicture()} style = {{backgroundColor: weeklyColor, paddingHorizontal: 5, width: 95, position: 'relative', bottom: 50, height: 95, borderRadius: 50, flexDirection: 'row', justifyContent: 'center'}}><Image
